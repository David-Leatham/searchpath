...
import { Title, StartSearchButton, ClearSearchButton, SearchAlgorithmsElements, MazeElements, StyleElements, SlowMazeGenerationToggleButton, GenerateMazeButton } from '@/lib/elements/elements'
